...
class BattleTest {
    ...
    void testStatusMove() {
        MoveScriptService mss = new MoveScriptService();
        BattleMove moveP1 = mss.createMove("trigger onUse += {action applyStatusOpponent (100, \"trapped\", 4);};");
    ...
    void testRandom() {
        MoveScriptService mss = new MoveScriptService();
        BattleMove moveP1 = mss.createMove("trigger onUse += {random 50 (action damage 40);};");
        BattleMove moveP2 = mss.createMove("trigger onUse += {};");
        ...
        Battle battle = new Battle(p1, p2, new BattleActions());
        battle.executeMoves();
        assertThat(p2.getSelectedDude().getHealth()).isEqualTo(60);
    }
}